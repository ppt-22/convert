...
def file_operations(r):
    create_dir_command = f"mkdir /home/pavan_pothams/projects/new/xdr-detection-ace-rules/rules/one_stage_rules/{file_name}/{r[0]}"
    create_file_command = f"touch /home/pavan_pothams/projects/new/xdr-detection-ace-rules/rules/one_stage_rules/{file_name}/{r[0]}/rule.yaml"
    test_folder = f"mkdir /home/pavan_pothams/projects/new/xdr-detection-ace-rules/rules/one_stage_rules/{file_name}/{r[0]}/positiveTests"
    test_file = f"touch /home/pavan_pothams/projects/new/xdr-detection-ace-rules/rules/one_stage_rules/{file_name}/{r[0]}/positiveTests/test.json"
    ...
    if os.path.isfile(f"/home/pavan_pothams/projects/TAP_Detection/rules/tests/negative/{r[0]}.json"):
        n_test_folder = f"mkdir /home/pavan_pothams/projects/new/xdr-detection-ace-rules/rules/one_stage_rules/{file_name}/{r[0]}/negativeTests"
        n_test_file = f"touch /home/pavan_pothams/projects/new/xdr-detection-ace-rules/rules/one_stage_rules/{file_name}/{r[0]}/negativeTests/test.json"
...
for r in rule_data:
    ...
    ace_path = f"/home/pavan_pothams/projects/new/xdr-detection-ace-rules/rules/one_stage_rules/{file_name}/{r[0]}/rule.yaml"
...
command_tags = f"python3 add_tags.py -v -r /home/pavan_pothams/projects/new/xdr-detection-ace-rules/rules/one_stage_rules/{file_name} -d {csv_file_path} --rule-tester /home/pavan_pothams/projects/ruletest --tag-ids tag_ids_new.json"
# Run the command with Popen
